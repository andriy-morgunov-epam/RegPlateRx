//
//  PlateUAMotocycleCellUIView.swift
//  RegPlateRx
//
...
struct PlateUAMotocycleCellUIView: View {
...
struct PlateUAMotocycleCellUIView_Previews: PreviewProvider {
        ...
        Group {
            VStack {
                ForEach([
                    ...
                    PlateUAMotocycleCellUIView(model: model)
