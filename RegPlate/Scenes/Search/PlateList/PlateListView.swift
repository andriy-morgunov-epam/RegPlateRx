...
struct PlateListView: View {
    ...
    @ObservedObject var viewModel: PlatesUAViewModel
                ...
                List {
                    ForEach(self.viewModel.items) { item in
                        ...
                        case
                            is PlateUAAuto04,
                            is PlateUAAuto15:
                                AnyView(PlateUAAutoCellView(model: plateModel))
                        ...
                        case
                            ...
                            is PlateUAAutoTemporaryDealer15:
                                AnyView(PlateUAAutoTemporaryCellView(model: plateModel))
                                .background(Color.clear)
                                .listRowBackground(Color.clear)
                        case
                            ...
                            is PlateUAMotocycleTemporaryDealer15:
                                AnyView(PlateUAMotocycleCellView(model: plateModel))
                                .background(Color.clear)
                                .listRowBackground(Color.clear)
                        case
                            ...
                            is PlateUAMotobikeTemporaryDealer04:
                                AnyView(PlateUAMotobikeCellView(model: plateModel))
                                .background(Color.clear)
                                .listRowBackground(Color.clear)
                        default:
                                AnyView(EmptyView())
