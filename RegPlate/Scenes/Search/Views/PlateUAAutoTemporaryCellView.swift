//
//  PlateUAAutoTemporaryCellView.swift
//  RegPlateRx
//
...
struct PlateUAAutoTemporaryCellView: View {
...
struct PlateUAAutoTemporaryCellView_Previews: PreviewProvider {
        ...
        Group {
            VStack {
                ForEach([
                    ...
                    PlateUAAutoTemporaryCellView(model: model)
