...
struct PlateUAMotobikeCellView: View {
...
struct PlateUAMotobikeCellView_Previews: PreviewProvider {
        ...
        Group {
            VStack {
                ForEach([
                    ...
                    PlateUAMotobikeCellView(model: model)
