...
class PlateUAAutoTests: XCTestCase
{
    ...
    {
        XCTAssertEqual(PlateUAAuto04.normalizedInput(""), "**####**", "Wrong Normalized")
        XCTAssertEqual(PlateUAAuto04.normalizedInput("A"), "A*####**", "Wrong Normalized")
        XCTAssertEqual(PlateUAAuto04.normalizedInput("AA"), "AA####**", "Wrong Normalized")
        XCTAssertEqual(PlateUAAuto04.normalizedInput("AA0"), "AA0###**", "Wrong Normalized")
        XCTAssertEqual(PlateUAAuto04.normalizedInput("AA00"), "AA00##**", "Wrong Normalized")
        XCTAssertEqual(PlateUAAuto04.normalizedInput("AA000"), "AA000#**", "Wrong Normalized")
        XCTAssertEqual(PlateUAAuto04.normalizedInput("AA0000"), "AA0000**", "Wrong Normalized")
        XCTAssertEqual(PlateUAAuto04.normalizedInput("AA0000A"), "AA0000A*", "Wrong Normalized")
        XCTAssertEqual(PlateUAAuto04.normalizedInput("AA0000AA"), "AA0000AA", "Wrong Normalized")
        
        XCTAssertEqual(PlateUAAuto04.normalizedInput("*A0000AA"), "*A0000AA", "Wrong Normalized")
        XCTAssertEqual(PlateUAAuto04.normalizedInput("**0000AA"), "**0000AA", "Wrong Normalized")
        XCTAssertEqual(PlateUAAuto04.normalizedInput("**#000AA"), "**#000AA", "Wrong Normalized")
        XCTAssertEqual(PlateUAAuto04.normalizedInput("**##00AA"), "**##00AA", "Wrong Normalized")
        XCTAssertEqual(PlateUAAuto04.normalizedInput("**###0AA"), "**###0AA", "Wrong Normalized")
        XCTAssertEqual(PlateUAAuto04.normalizedInput("**####*A"), "**####*A", "Wrong Normalized")
        XCTAssertEqual(PlateUAAuto04.normalizedInput("**####**"), "**####**", "Wrong Normalized")
        XCTAssertEqual(PlateUAAuto04.normalizedInput("AA0000AA"), "AA0000AA", "Wrong Normalized")
        XCTAssertEqual(PlateUAAuto04.normalizedInput("AA0000AA"), "AA0000AA", "Wrong Normalized")
